<h2 align="center">Open Prayer Book</h2>
<h3 align="center">A project to produce free electronic text versions of the public domain Anglican prayer books</h3>
...
To the extent permitted by law, all contents of this repository are in the public domain, and released under the [CC0 license](LICENSE).

The electronic texts in this repository of the 1979 United States edition of the Book of Common Prayer have not been approved by the Custodian of the Standard Book of Common Prayer, and are not intended for use as of authority in the Episcopal Church. The Certificate on page 2 has been retained for reference only.
